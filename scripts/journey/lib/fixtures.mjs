 ...
 * The broad journey catalog runs the identical journey against both theme
 * projects (see playwright.journey.config.mjs) and Storybook stories read the
 * theme from the `theme` global (withThemeByDataAttribute in
